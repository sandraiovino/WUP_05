...
```
When running this barchart it shows that placebo is more effective than the drug treatment. 
...
colPerc(table1)
```
This numerical results shows that about 76% of the placebob treatments for druggies where more effective than the actually Aids treatment which was 24%.  
